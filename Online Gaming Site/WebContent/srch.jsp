						...
						<table class="related">
							...
							<%
								try { 
									...
									String sql2 ="SELECT * FROM game order by RAND() LIMIT 3";
		...
		<div class="tab-win" align="right">
			...
			<%
				try { 
					...
					String sql ="SELECT * FROM game where name like '"+search+"' OR subCategory like '"+search+"' OR genre like '"+search+"' OR developer like '"+search+"' OR publisher like '"+search+"' order by gameID desc";
					String sql1 = "SELECT count(*) as Count FROM game where name like '"+search+"' OR subCategory like '"+search+"' OR genre like '"+search+"' OR developer like '"+search+"' OR publisher like '"+search+"' order by gameID desc";
					...
					//count for empty
					res3 = stmt3.executeQuery(sql1);
					
					while(res3.next()) {
						
						if(res3.getInt("Count") < 1) {
						
			%>
					<style>
						.back-rec { height : 1000px;
						}
					</style>
					
					<h1 align = "left" style = "font-weight:bold; font-size : 25px;">No Results Found</h1>	
					<p align = "left" style = "font-weight:bold; font-size:15px;">The page you requested could not be found. Please try refining your search !</p>
