...
<body background="images/tomb1.png">
	...
	<center>
		<div class="back-rec1">
			...
			<center>
			<form name = "game" action="Addgamess" method = "post" >
				<fieldset style = "margin-top : 10px;">
					<legend class="log"><h3 style = "font-size : 30px; font-weight:bold; width:400px;">Add new games</h3></legend>
						...
						<table class="regis_frm" style = "padding:10px; border-style:solid 1px; ">
							...
							<tr>
								<td align = "center"><p class="form_title" style="font-size: 17px;">Game name</p>
						 			<input type="text" name="game_name" class="input_txt" required="required">
						 		</td>
						 		
						 		<td align = "center"><p class="form_title" style="font-size: 17px;">Title</p>
						 			<input type="text" name="game_title" class="input_txt" required="required">
						 		</td>
									
								
								<td align = "center"><p class="form_title" style="font-size: 17px;">Genre</p>
						 			<input type="text" name="game_genre" class="input_txt" placeholder="" required="required">
						 		</td>
							...
							<tr>
								...
								<td align = "center"><p class="form_title" style="font-size: 17px;">Developer</p>
						 			<input type="text" name="game_dev" class="input_txt" required="required">
						 		</td>
						 		
						 		<td align = "center"><p class="form_title" style="font-size: 17px;">Publisher</p>
						 			<input type="text" name="game_pub" class="input_txt" placeholder="" required="required">
						 		</td>
						 		
						 		<td align = "center"><p class="form_title" style="font-size: 17px;">Release Date</p>
							       	<input type="text" name="game_rldate" class="input_txt" placeholder="" required="required">
							    </td>
                            ...
                            <tr>	
                                ...
                                <td align = "center"><p class="form_title" style="font-size: 17px;">Languages</p>
						 		<input type="text" name="game_languages" class="input_txt" placeholder="" required="required">
						 		</td>
                                   
								<td align = "center"><p class="form_title" style="font-size: 17px;">File size </p>
						 			<input type="text" name="game_size" class="input_txt" required="required">
						 		</td>
						 		
						 		<td align = "center"><p class="form_title" style="font-size: 17px;"> Downloads</p>
						 			<input type="text" name="game_down" class="input_txt" placeholder="" required="required">
						 		</td>
							...
							<td align = "center"><p class="form_title" style="font-size: 17px;">Status</p>
						 	...
						 	<td align = "center"><p class="form_title" style="font-size: 17px;">Sub Category</p>						
									<select name ="game_subcat" class = "input_txt">
							...
							<tr>
									...
									<td align = "center"><p class="form_title" style="font-size: 17px;">Mega Down</p>
						 			<input type="text" name="game_mdown" class="input_txt" placeholder="" required="required">
						 			</td>
						 			
						 			<td align = "center"><p class="form_title" style="font-size: 17px;">UploadDown</p>
						 			<input type="text" name="game_updown" class="input_txt" placeholder="" required="required">
						 			
						 			<td align = "center"><p class="form_title" style="font-size: 17px;">Driver Down</p>
						 			<input type="text" name="game_ddown" class="input_txt" placeholder="" required="required"></td>
						 			</td>
							...
							<td></td>
								...
								<td>
								<center>
								<input type="submit" value="Add" class="sub_btn" style ="margin:5%;" >
